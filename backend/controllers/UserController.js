...
const authenticateUser = asyncHandler(async (req, res) => {
 // console.loglog("User Working")
 // console.loglog(req.body)
    ...
    .populate({
      ...
      populate: [
        ...
        },
        {
          path: "chat",
          model: "Chat",
          select: "-groupAdmins -keyOne -keytwo -cloudinary_id",
          populate: {
            path: "users",
            model: "User",
            select: "-password -notifications",
...
const deleteNotifications = asyncHandler(async (req, res) => {
 ...
 // console.loglog("deleteNotifications");
