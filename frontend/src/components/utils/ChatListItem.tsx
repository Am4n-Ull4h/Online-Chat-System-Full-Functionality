...
const ChatListItem = ({ chat, chatNotifCount, typingChatUser }: Props) => {
  ...
  return (
    <div
      ...
      className={`chatListItem w-100 user-select-none text-light pointer ${selectedChat?._id === _id ? "isSelected" : ""
    ...
    >
      ...
      >
        <Avatar
          src={"http://localhost:5000/uploads/" + chatDisplayPic as string}
          alt={chatName}
          data-chat={_id}
          data-has-notifs={chatNotifCount}
