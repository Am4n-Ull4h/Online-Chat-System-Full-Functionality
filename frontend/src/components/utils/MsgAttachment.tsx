...
const MsgAttachment = ({
  ...
  const previewStyles = `${isPreview && !isEditMode
    ...
    <>
      {isEditMode ? (
        ...
        <span
          ...
          className={`downloadIcon ${isDownloadingFile ? "downloading" : ""} ${isPreview || !msgSent ? "d-none" : ""
            }`}
  ...
  return (
    <>
      {fileUrl?.startsWith(IMG_BASE_URL) || isImageOrGifFile(file_name) || fileType === "PNG" ? (
        <span className="d-inline-block msgImageWrapper mb-2 position-relative">
          <img
            src={"http://localhost:5000/uploads/" + fileUrl}
            alt={file_name}
            title={file_name}
          ...
          {fileType === "PDF" ? (
            ...
            <div className={`${previewStyles} msgFile mediaFile`}>
              ...
              >
                          ...
                          <video controls width="400" height="300">
                            <source className={`playMedia `}  src={"http://localhost:5000/uploads/" + file_name} type="video/mp4" />
                          </video>
              </div>
            </div>
          ) : fileType === "Audio" ? (
            ...
            >
              ...
              >
                <PlayArrow
                  data-audio={file_id}
                  data-audio-name={"http://localhost:5000/uploads/" + file_name}
