...
const MessagesView = ({
  ...
  const loadMedia = async (
    ...
    try {
      const { data } = await axios.get(
        `http://localhost:5000/api/message/files/${fileId}`,
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const apiUrl = isNonImageFile
        ? `http://localhost:5000/api/message/upload-to-s3`
  ...
  const updateMessage = async (
    ...
    try {
      // Upload img/gif to cloudinary, and all other files to aws s3
      const apiUrl = isNonImageFile
        ? `http://localhost:5000/api/message/update-in-s3`
          ...
          >
            ...
            >
              ...
              >
                ...
                <CustomTooltip title="Attach Files" placement="top-start" arrow>
                  <IconButton
